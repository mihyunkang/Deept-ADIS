...
from misc_function_train import preprocess_image, recreate_image, get_params
...
class FastGradientSignTargeted():
    ...
    def __init__(self, model, alpha):
        ...
        if not os.path.exists('../generated/targeted/traindata'):
            os.makedirs('../generated/targeted/traindata')
    ...
    def generate(self, original_image, org_class, target_class, image_path):
        ...
        for i in range(10):
            ...
            if confirmation_prediction == target_class:
                ...
                #cv2.imwrite('../generated/targeted/traindata/noise_from_' + image_path+'_'+str(org_class) + '_to_' +
                #            str(confirmation_prediction) + '.jpg', noise_image)
                # Write image
                cv2.imwrite('../generated/targeted/traindata/adv_img_from_' + image_path+ '_'+str(org_class) + '_to_' +
...
if __name__ == '__main__':
    ...
    folder_pth = 'D:/full_data/train/real'
